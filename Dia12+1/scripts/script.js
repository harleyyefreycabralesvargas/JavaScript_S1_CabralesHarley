document.addEventListener('DOMContentLoaded',()=>{
    ...
    async function fetchData(){
        const res = await fetch('https://6814358a225ff1af16282ac0.mockapi.io/CRUD/Tareas');
        data = await res.json();
        return data;
    }
    ...
    async function botonCompletado(event){
        ...
        console.log(id);
        await fetch(`https://6814358a225ff1af16282ac0.mockapi.io/CRUD/Tareas/${id}`,{
            method:'PUT',
            headers:{
    ...
    async function addNewTask(){
        ...
        if(task.trim()===''){
            ...
            await fetch(`https://6814358a225ff1af16282ac0.mockapi.io/CRUD/Tareas/`,{
                method:'POST',
                headers:{
                    'Content-Type':'application/json'
                },
